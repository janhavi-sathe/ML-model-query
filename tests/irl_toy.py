...
import click
from aicoach.algs.IRL.maxent_irl import (MaxEntIRL, compute_relative_freq,
                                         cal_reward_error, cal_policy_error)
from aicoach.algs.IRL.cg_maxent_irl import CGMaxEntIRL
from aicoach.algs.IRL.constraints import (Equation, NumericalRelation,
                                          RewardConstraints)
from TMM.models.mdp import MDP
from TMM.algs import value_iteration
from TMM.models.mdp import StateSpace, ActionSpace
from aicoach.algs.utils.exceptions import InvalidTransitionError
...
def main(gen_data, maxent_irl, cg_maxent_irl, tabular_bc, dnn_bc, sb3_gail,
  ...
  import aicoach.algs.BTIL_baselines.sb3_algorithms as sb3_algs
  if dnn_bc:
