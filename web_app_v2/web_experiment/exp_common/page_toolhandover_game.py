...
class ToolHandoverGamePage(ToolHandoverGamePageBase):
  ...
  def __init__(self,
    ...
    # self._TEAMMATE_POLICY = ToolHandoverPolicy
    x = 5
  ...
  def _on_game_finished(self, user_game_data: Exp1UserData):
    ...
    game = user_game_data.get_game_ref()  # type: ToolHandoverSimulator
...
class ToolHandoverUserRandom(ToolHandoverGamePage):
